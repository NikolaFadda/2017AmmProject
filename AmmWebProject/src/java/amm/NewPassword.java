...
public class NewPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String repPass = request.getParameter("repNewPassword");
        
        if(UtenteFactory.getInstance().getUtenteByUsernameAndPassword(usr, oldPass)){
        
            if(newPass.equals(repPass)){
            
                UtenteFactory.getInstance().alterPassword(usr, newPass);
